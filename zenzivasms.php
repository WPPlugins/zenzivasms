...
function user_settings(){
    ...
    <div style="padding: 5px; font-size:11px"><i>Plugin Wordpress ZenzivaSMS menggunakan account dari Zenziva. Jika belum mempunyai account, silahkan <a href="http://www.zenziva.com/form_register.php" target="_blank">daftar</a> terlebih dahulu.</i><br /></div>
<?php }
